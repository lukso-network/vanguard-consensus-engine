...
require (
	...
	github.com/prysmaticlabs/ethereumapis v0.0.0-20210819180115-d3a4ac5a0a2d
...
replace github.com/ferranbt/fastssz => github.com/atif-konasl/fastssz v0.0.0-20210825113045-242c536f4f90
