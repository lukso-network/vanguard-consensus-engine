...
// Source: github.com/prysmaticlabs/prysm/proto/eth/v1alpha1 (interfaces: BeaconChainClient,BeaconChain_StreamChainHeadClient,BeaconChain_StreamAttestationsClient,BeaconChain_StreamBlocksClient,BeaconChain_StreamValidatorsInfoClient,BeaconChain_StreamIndexedAttestationsClient,BeaconChain_StreamMinimalConsensusInfoClient,BeaconChain_StreamNewPendingBlocksClient)
...
// Recv mocks base method
func (m *MockBeaconChain_StreamMinimalConsensusInfoClient) Recv() (*eth.MinimalConsensusInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*eth.MinimalConsensusInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// RecvMsg mocks base method
func (m *MockBeaconChain_StreamMinimalConsensusInfoClient) RecvMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecvMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// RecvMsg indicates an expected call of RecvMsg
func (mr *MockBeaconChain_StreamMinimalConsensusInfoClientMockRecorder) RecvMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockBeaconChain_StreamMinimalConsensusInfoClient)(nil).RecvMsg), arg0)
}

// SendMsg mocks base method
func (m *MockBeaconChain_StreamMinimalConsensusInfoClient) SendMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// SendMsg indicates an expected call of SendMsg
func (mr *MockBeaconChain_StreamMinimalConsensusInfoClientMockRecorder) SendMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockBeaconChain_StreamMinimalConsensusInfoClient)(nil).SendMsg), arg0)
}
...
// MockBeaconChain_StreamNewPendingBlocksClient is a mock of BeaconChain_StreamNewPendingBlocksClient interface
type MockBeaconChain_StreamNewPendingBlocksClient struct {
	ctrl     *gomock.Controller
	recorder *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder
}

// MockBeaconChain_StreamNewPendingBlocksClientMockRecorder is the mock recorder for MockBeaconChain_StreamNewPendingBlocksClient
type MockBeaconChain_StreamNewPendingBlocksClientMockRecorder struct {
	mock *MockBeaconChain_StreamNewPendingBlocksClient
}

// NewMockBeaconChain_StreamNewPendingBlocksClient creates a new mock instance
func NewMockBeaconChain_StreamNewPendingBlocksClient(ctrl *gomock.Controller) *MockBeaconChain_StreamNewPendingBlocksClient {
	mock := &MockBeaconChain_StreamNewPendingBlocksClient{ctrl: ctrl}
	mock.recorder = &MockBeaconChain_StreamNewPendingBlocksClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockBeaconChain_StreamNewPendingBlocksClient) EXPECT() *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder {
	return m.recorder
}

// CloseSend mocks base method
func (m *MockBeaconChain_StreamNewPendingBlocksClient) CloseSend() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CloseSend")
	ret0, _ := ret[0].(error)
	return ret0
...
// CloseSend indicates an expected call of CloseSend
func (mr *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder) CloseSend() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseSend", reflect.TypeOf((*MockBeaconChain_StreamNewPendingBlocksClient)(nil).CloseSend))
}

// Context mocks base method
func (m *MockBeaconChain_StreamNewPendingBlocksClient) Context() context.Context {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Context")
	ret0, _ := ret[0].(context.Context)
	return ret0
...
// Context indicates an expected call of Context
func (mr *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder) Context() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Context", reflect.TypeOf((*MockBeaconChain_StreamNewPendingBlocksClient)(nil).Context))
}

// Header mocks base method
func (m *MockBeaconChain_StreamNewPendingBlocksClient) Header() (metadata.MD, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Header")
	ret0, _ := ret[0].(metadata.MD)
	ret1, _ := ret[1].(error)
...
// Header indicates an expected call of Header
func (mr *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder) Header() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Header", reflect.TypeOf((*MockBeaconChain_StreamNewPendingBlocksClient)(nil).Header))
}
...
// Recv indicates an expected call of Recv
func (mr *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder) Recv() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Recv", reflect.TypeOf((*MockBeaconChain_StreamNewPendingBlocksClient)(nil).Recv))
}

// RecvMsg mocks base method
func (m *MockBeaconChain_StreamNewPendingBlocksClient) RecvMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecvMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// RecvMsg indicates an expected call of RecvMsg
func (mr *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder) RecvMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockBeaconChain_StreamNewPendingBlocksClient)(nil).RecvMsg), arg0)
}

// SendMsg mocks base method
func (m *MockBeaconChain_StreamNewPendingBlocksClient) SendMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// SendMsg indicates an expected call of SendMsg
func (mr *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder) SendMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockBeaconChain_StreamNewPendingBlocksClient)(nil).SendMsg), arg0)
}

// Trailer mocks base method
func (m *MockBeaconChain_StreamNewPendingBlocksClient) Trailer() metadata.MD {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Trailer")
	ret0, _ := ret[0].(metadata.MD)
	return ret0
...
// Trailer indicates an expected call of Trailer
func (mr *MockBeaconChain_StreamNewPendingBlocksClientMockRecorder) Trailer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Trailer", reflect.TypeOf((*MockBeaconChain_StreamNewPendingBlocksClient)(nil).Trailer))
}
